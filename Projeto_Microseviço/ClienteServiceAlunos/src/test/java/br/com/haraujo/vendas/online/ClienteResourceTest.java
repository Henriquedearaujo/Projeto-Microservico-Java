 ...
 * 
 */
package br.com.haraujo.vendas.online;
...
import br.com.haraujo.vendas.online.reources.ClienteResource;
import br.com.haraujo.vendas.online.usecase.BuscaCliente;
import br.com.haraujo.vendas.online.usecase.CadastroCliente;
...
public class ClienteResourceTest {
	...
	public void buscarPorId() {
		Cliente cliente1 = Cliente.builder().id("1").nome("Henrique 1").build();
